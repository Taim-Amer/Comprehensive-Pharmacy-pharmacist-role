    ...
    return Column(
      ...
      children: [
        Row(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(TranslationKey.kOrderID, style: Theme.of(context).textTheme.titleLarge?.copyWith(fontSize: 20, fontWeight: FontWeight.w500)),
            TRoundedContainer(
              backgroundColor: TColors.primary.withOpacity(.3),
              radius: 100.r,
              height: 30.h,
              padding: const EdgeInsets.all(8),
              child: Center(child: Text(TranslationKey.kCompleted, style: Theme.of(context).textTheme.labelMedium?.copyWith(color: TColors.primary, fontSize: 10, fontWeight: FontWeight.w500))),
            )
          ],
        ),
